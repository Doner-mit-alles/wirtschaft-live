...
<template>
  <footer class="container mt-5 px-5 px-lg-5 px-md-4" id="footer">
    <div class="row g-3 mb-4">
      <div class="footer-wrapper col-12 mb-4 d-flex flex-md-nowrap flex-wrap justify-content-around">
        ...
        <div class="row">
          ...
          <div class="col-10 align-self-center">
            <a href="https://www.instagram.com/bbs1lg/">BBS 1 Lueneburg</a>
          </div>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-10 align-self-center">
            <a href="https://www.w3schools.com">04131 99220600</a>
          </div>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-10 align-self-center">
            <a href="https://www.w3schools.com">info@bbs1-lueneburg.de</a>
          </div>
        </div>
        <div class="vr"/>
